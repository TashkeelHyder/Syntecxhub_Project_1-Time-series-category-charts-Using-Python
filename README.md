# Syntecxhub_Project_1-Time-series-category-charts-Using-Python
Exploratory Data Analysis (EDA) of Superstore sales using Python, Pandas, and Matplotlib to uncover seasonal trends and category performance


Project Objectives & Insights

1. Sales Trends & Periodicity (Monthly & Quarterly)

•	Objective: Plot sales over time using line charts with both monthly and quarterly aggregations.
•	Insight: * Monthly: Revealed sharp peaks every November and December, indicating a strong holiday impact.

o	Quarterly: By aggregating data into quarters, I identified a consistent Q4 surge across all years, which helps the business plan for inventory and staffing levels months in advance.
...
•	Insight: Standard Class is the most preferred method by far, used for over 30,000 orders.
•	Business Impact: This suggests that the customer base is highly price-sensitive and willing to accept longer delivery times for lower costs.
